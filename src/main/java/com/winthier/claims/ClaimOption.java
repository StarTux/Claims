...
public class ClaimOption {
    ...
    static ClaimOption booleanOption(String key, String displayName, String description, String defaultValue) {
    ...
    static ClaimOption intOption(String key, String displayName, String description, String defaultValue, int min, int max) {
